...
| `ConversationCase` | the Interaction Case with which a Conversation gives way to a Sequence | optional Interaction Condition, Sequence identity, close or resume outcome | read from the top, first eligible case applies; evaluates committed Game State; generated wording has no authority | Conversation case definition/condition/Sequence diagnostics | [Dialogue](authoring/dialogue.md) |
