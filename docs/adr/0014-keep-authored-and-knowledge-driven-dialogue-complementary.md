...
conditions, never generated speech or an LLM, decide when play moves between
them, avoiding both rigid dialogue trees for investigation and loss of authorial
control over directed scenes.
