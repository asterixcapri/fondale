...
the startup compilation validates them; the Core resolves each identifier from
the project registries when behavior needs it. This keeps authored data declarative and
